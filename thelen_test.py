#Thelen's Code for whoosh library
...
schreiber.add_document(title=u"First document", content=u"This is the first document we've added!")
schreiber.add_document(title=u"Second document", content=u"The second one is even more interesting!")
schreiber.add_document(title=u"Songtext", content=u"Music was my first love and it will be the last")
